...
async function main() {
  ...
  // Add this to your seed file after the other branches
  const hawassaBranch = await prisma.branch.create({
    data: {
      ...
      directionsUrl: "https://maps.app.goo.gl/hawassa-resort",
      starRating: 4,
      published: true,
      ...
      contact: {
        create: {
          phone: "+251 46 220 1234",
          email: "hawassa@haileresorts.com",
          address: "Lake Hawassa Shore, Hawassa, Ethiopia",
          socials: {
            facebook: "https://facebook.com/hailehawassa",
            instagram: "https://instagram.com/hailehawassa",
          },
        },
      },
    },
