// app/admin/8systemAdmin/user-role/components/modals/EditUserModal.tsx
"use client";
...
export default function EditUserModal({
  ...
  const [formData, setFormData] = useState({
    ...
    email: "",
    roleId: "",
    branchSlug: "", // Changed from branchId to branchSlug
  ...
  useEffect(() => {
    ...
    setFormData({
      ...
      branchSlug: user.branch?.slug || "", // Changed to slug
      status: user.status,
    });
  }, [user]);
