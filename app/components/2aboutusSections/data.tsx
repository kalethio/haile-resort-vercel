...
export const brand = {
  ...
  lemon: "#D8E032",
  fonts: {
    ui: "Open Sans, system-ui, -apple-system, 'Segoe UI', Roboto, 'Helvetica Neue'",
    heading: "Noto Serif, 'Noto Serif Ethiopic', Georgia, serif",
  },
};

export const heroData = {
  title: 'All in one service built by "ይቻላል"(It is possible)',
  sub: "A legacy of warmth, modern comfort and Ethiopian soul — discover who we are and where we're going.",
  image: "/images/about/hero-immersive.jpg",
  overlay: 34,
};
...
export const historyData = {
  heading: "History",
  lead: "Haile Hotels and Resorts: from a single property in Hawassa to a rising national chain.",
  paragraphs: [
    `Haile Hotels and Resorts began in Hawassa in 2010 as a four-star property anchored in local character and modern standards. Over the subsequent decade the brand expanded thoughtfully, opening properties that balance design, comfort and cultural sensitivity.`,
    `Today we operate eight active destinations across Ethiopia: Hawassa (our pioneer), Arba Minch, Adama, Gondar, Batu-Ziway, Yaya-Athletics Village (Sululta), Haile Grand Addis Ababa (flagship 5-star), and other strategic locations in development. Some sites are being modernized or temporarily offline as part of an operational optimization program focused on service quality and safety.`,
    `Our trajectory is deliberately phased: each new property is selected and operated to preserve the brand promise — location advantage, guest comfort, design integrity, and community integration.`,
  ],
};
